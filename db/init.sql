-- Aurelia initial database schema
...
CREATE TABLE IF NOT EXISTS categories (
    ...
    color VARCHAR(7),   -- hex color e.g. #7c3aed
...
CREATE TABLE IF NOT EXISTS documents (
    ...
    file_size    BIGINT,
    type         VARCHAR(50) NOT NULL DEFAULT 'unknown', -- 'bank_statement', 'invoice', 'csv', etc.
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    raw_category VARCHAR(100),  -- AI-assigned before user confirmation
...
CREATE TABLE IF NOT EXISTS chat_messages (
    ...
    sources    JSONB,       -- [{doc_id, chunk_id, excerpt}]
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
